...
export default () => (
    <div className="reserved_description">
        <p>
            ...
            with an additional requirement 0.5 XLM for each entry in the account such as a trustline or offer. You can
        ...
        <p>
            ...
            StellarFish enforces a 0.5 XLM of extra minimum balance in an attempt to make sure your account can still
        ...
        <p>
            ...
            <Link to="/account/addTrust/">unaccept an asset</Link>. If you would like to close your Stellar account and
            withdraw assets somewhere else you can use{' '}
