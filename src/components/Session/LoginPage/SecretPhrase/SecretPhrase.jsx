    ...
    getSecretPhraseMainBlock() {
            ...
            return (
                <React.Fragment>
                    ...
                    <p className="SecretPhrase_content">
                        Secret Phrase can help you verify that you are using authentic StellarFish website and save you
                        from phishing attacks.
                    </p>
                    <p
                        onClick={() =>
                            this.props.d.modal.handlers.activate('SecretPhraseSetup', () => this.handleUpdate())
                        }
        ...
        return (
            <React.Fragment>
                ...
                <p className="SecretPhrase_phrase">{secretPhrase}</p>
                <p className="SecretPhrase_description">
                    Secret Phrase could be missing if you access StellarFish from a new device or a new browser.
                </p>
            </React.Fragment>
        );
    }
