        ...
        return (
            <div className="BrowserModal">
                ...
                <div className="BrowserModal_content">
                    ...
                    <p className="browser_title">It looks like your {getBrowserName()} is outdated.</p>

                    <p className="browser_description">
                        We have determined that you may be using a web browser version that is not supported by
                        StellarFish. An outdated browser version may prevent you from accessing certain features.
                        Consider updating to the most recent version of your browser or try a different modern browser
