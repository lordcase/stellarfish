...
export default class SecretPhraseModalBlock extends React.Component {
        ...
        return (
            <React.Fragment>
                ...
                <p className="SecretPhrase_content">
                    Secret Phrase can help you verify that you are using authentic StellarFish website and save you from
                    phishing attacks.
                </p>
                <p
                    onClick={() => {
                        this.props.d.modal.handlers.cancel();
                        this.props.d.modal.handlers.activate('SecretPhraseSetup', () => {});
                    }}
    ...
    render() {
        ...
        return <div className="SecretPhraseModalBlock-wrap SecretPhrase">{content}</div>;
    }
}
