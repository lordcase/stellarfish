    ...
    renderHomePageActions() {
        ...
        return (
            <div className="HomePage__lead__actions">
                <Link className={signUpLinkClass} to="/signup/">
                    New account
                </Link>
                &nbsp;
                <Link className="s-button HomePage__lead__actions__button" to="/account/">
                    Log in
                </Link>
            </div>
        );
                    ...
                    <div className="so-back">
                        <div className="HomePage__lead">
                            ...
                            <p className="HomePage__lead__summary">
                                ...
                                .
                                <br />
                                Send, receive, and <Link to="/exchange/">trade</Link> assets on the Stellar network
                                easily with StellarFish.
                            </p>
                        ...
                        <div className="island__sub">
                            <div className="island__sub__division">
                                <div className="HomePage__sideBlurb">
                                    <p>
                                        StellarFish is just a client that can be used to access the Stellar
                                        Decentralized Exchange. Neither StellarFish nor the developers of it are
                                        involved with operating the Stellar network.
                                    </p>
                                    <p>
                                        Stellar Fish is forked from Stellar Term open source project by DLabs
                                        development team. Our project will go on its own way, with unique development
                                        directions, focusing on the most useful features and security.
                                        <br />
                                        Stellar Fish runs in the browser, keys are never sent to any server and
                                        transactions are only signed locally. Stllar Fish developers never see private
                                        keys.
                                        <br />
                                        Create an account, send, receive and trade assets on the stellar network easily
                                        with Stellar fish.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="island__sub__division">
                                <div className="HomePage__sideBlurb">
                                    <p>
                                        StellarFish is open source software. To support the project, please{' '}
                                        <a
                                            href="https://github.com/stellarterm/stellarterm"
                                            target="_blank"
                                            rel="nofollow noopener noreferrer"
                                    ...
                                    <p>
                                        The project is released under the Apache-2.0 license and is released as is
                                        without warranty.
                                    </p>
                                    <p>
                                        StellarFish is not a custodian of your assets. We do not store any tokens,
                                        cryptoassets or private keys on your behalf.
                                    </p>
                                </div>
                            </div>
                        </div>
