            ...
            <div className="Error_boundary">
                <Generic>
                    <div className="Error_boundary_title">
                        ...
                        <p>
                            Don’t worry <strong>your funds are safe</strong> and not affected by this error. This error
                            is just a display error in StellarFish, and is not your fault.
                        </p>
                    </div>
                    <div className="Error_content">
                        <p>
                            If you want to help this error get fixed, please report it to the GitHub issue tracker
                            adding:
                        </p>
